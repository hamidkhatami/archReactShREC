...
const FeeSetting: React.FC = () => {
    const [issuerer, setIsuerer] = useState<number>();
    const [acquirer, setAcquirer] = useState<number>();
    const [shetab, setShetab] = useState<number>();
    const[bankDestinition,setBankDesination]=useState<number>();
    ...
    const data: Setting[] = [
        ...
        { id: 2, transactionType: "اعلام مانده کارت و صورتحساب 10 گردش آخر", terminalType: "پایانه شعب PINPAD", acquirer: 2450, shetab: 500, issuer: 500, bankDes: 300 },
